    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($testimonial) {
                return '
                <a href="' . route('admin.testimonial.edit', $testimonial) . '" class="btn btn-link"><i class="bx bx-pencil"></i></a>
                <button type="button" class="btn btn-link text-danger btn-delete" data-href="' . route('admin.testimonial.destroy', $testimonial) . '"><i class="bx bx-trash"></i></a>
            ';
            })
            ->addColumn('image', function ($testimonial) {
                return $testimonial->image ?
                    '<img src="' . $testimonial->image . '" class="table-img" loading="lazy" />'
                    : 'Not Uploaded';
            })
